...
""" the specification for the ISOXML entities
...
AFE_map = {"A": "FilenameWithExtension", "B": "Preserve", "C": "ManufacturerGLN", "D": "FileType", "E": "FileVersion", "F": "FileLength"}
AFE_ctags = []
...
TSK_ctags = [ "TZN", "TIM", "OTP", "WAN", "DAN", "CNN", "PAN", "DLT", "CAN", "TLG", "GRD", "CAT", "GAN"]
